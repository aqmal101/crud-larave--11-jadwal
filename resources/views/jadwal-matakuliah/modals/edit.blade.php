<div class="modal fade" id="modalEditData{{ $row->kd_jadwal }}" tabindex="-1" aria-labelledby="modalEditData"
    aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form method="post" action="{{ route('edit-jadwal-matakuliah', $row->kd_jadwal) }}">
                @csrf
                @method('PUT')
